...
def getArgs(showHelp=0):
    ...
    parser.add_argument(
        "-t", "--tileset",
        help="select the tileset folder to use (inbuilt theme picker if not used)")
    parser.add_argument(
        "-m", "--measure",
    ...
    parser.add_argument(
        "-p", "--pixels",
        help="specify the size of the squares to scale your image to (default 70)",
        default=70)
    parser.add_argument(
        "-r", "--randomise",
    ...
    parser.add_argument(
        "-s", "--savetiles",
        help="save any tile assets you created through this script (good for making themes)",
        action="store_true")
